<template>
  ...
  >
    <SwiperSlide>
      ...
      <h2 class="t-text-white">個人資訊簡歷的頁面</h2>
      <p class="t-text-white">就簡簡單單的簡歷，隨時增加或優化。</p>
    ...
    <SwiperSlide>
      ...
      <h2 class="t-text-white">RGB色碼表</h2>
      <p class="t-text-white">調出喜歡的顏色並提供色碼，Background color會隨著不同的值跟著變換。</p>
    ...
    <SwiperSlide>
      ...
      <h2 class="t-text-white">載入中的狀態頁面</h2>
      <p class="t-text-white">七彩旋轉的載入畫面</p>
    ...
    <SwiperSlide>
      ...
      <div class="!t-max-h-[100px] t-overflow-auto">
        <h2 class="t-text-white">以前端VUE3框架開發網站(簡易倉庫系統)</h2>
        <p class="t-text-white t-truncate">簡單的倉庫紀錄系統(紀錄出入庫、產品外包狀態、廠商管理、模具管理)因之前開發的專案經使用者提出各種想法後，我以前端框架開發更能給使用者良好操作體驗，故又另自學VUE框架並使用axios串接先前以全端開發之API再次開發簡易出入庫倉庫系統。因有帳密保護，故專案連結無法詳細展示。(可於面試時展示)</p>
    ...
    <SwiperSlide>
      ...
      <h2 class="t-text-white">登出圖案</h2>
      <p class="t-text-white">只用 tailwind 畫出開關門小動畫，點擊後 3 秒會離開該頁。</p>
    ...
    <SwiperSlide>
      ...
      <h2 class="t-text-white">不同的展示所有作品方式</h2>
      <p class="t-text-white">使用 swiper 套件。</p>
    ...
    <SwiperSlide>
      ...
      <h2 class="t-text-white">努力練習產出中..</h2>
      <p class="t-text-white">努力找目標練習產出中...</p>
